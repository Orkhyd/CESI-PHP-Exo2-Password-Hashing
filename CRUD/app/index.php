...
if (isset($_POST['add_user'])) {
    $user->createUser($_POST['first_name'], $_POST['last_name'], $_POST['email'], password_hash($_POST['pwd'],"bcrypt"));
}

// Modifier un utilisateur
if (isset($_POST['update_user'])) {
    $user->updateUser($_POST['id'], $_POST['first_name'], $_POST['last_name'], $_POST['email'], password_hash($_POST['pwd'],"bcrypt"));
}
